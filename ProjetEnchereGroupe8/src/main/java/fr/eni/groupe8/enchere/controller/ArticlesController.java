...
/******************************************************************************************************/
	...
	public String afficherNouvelleVente(@ModelAttribute Article article, Principal principal, Model model) {
		...
		String email = principal.getName(); // Principal, c'est l'utilisateur authentifié
		Utilisateur aCharger = contexteService.findUtilisateurByEmail(email); //recuperation de l'utilisateur par son email
		...
		model.addAttribute("user", aCharger); // ajoute des objets au model 
